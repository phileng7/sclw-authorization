...
@Service
public class DBServiceSchemaSimple {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Pessoa pes1 = new Pessoa(1, null, "Alex Cunha", "lekcunha@gmail.com", "acunha", bCrypt.encode("Alekcun$284"), null, 1, null, Perfil.ADMIN);		
		Pessoa pes2 = new Pessoa(2, null, "Felipe", "fmesy@outlook.com", "fmes", bCrypt.encode("123"), null, 1, null, Perfil.ADMIN);
		Pessoa pes3 = new Pessoa(3, null, "Admin", null, "admin", bCrypt.encode("Admincon$743"), null, 1, null, Perfil.ADMIN);
		Pessoa pes4 = new Pessoa(4, null, "Gestor", null, "gestor", bCrypt.encode("Congest$841"), null, 1, null, Perfil.GESTOR);
		Pessoa pes5 = new Pessoa(5, null, "Atendente", null, "atend", bCrypt.encode("Atdmais$910"), null, 1, null, Perfil.ATENDENTE);
